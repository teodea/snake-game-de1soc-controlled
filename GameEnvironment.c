...
volatile int * SW_ptr         = 0x00000040;     // SW slide switch address
volatile int * LEDR_ptr       = 0x00000000;    // red LED address
volatile int * KEY_ptr       = 0x00000050;    // red LED address
int switch_value = 0;
int key_value = 0;
bool move_up = false;
...
int main(void) {
	volatile int * pixel_ctrl_ptr = (int *)0x00003020;
